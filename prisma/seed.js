...
// ── CHANGE THIS ───────────────────────────────────────────────────────────────
const BOOKING_ID = "924ba313-2f44-4467-a4ae-315aee27b991";
// ─────────────────────────────────────────────────────────────────────────────

const feedback = {
  summary:
    "Rishu demonstrated a solid understanding of React fundamentals and component architecture. He approached problems methodically and showed good instincts around state management. With some refinement in system design and async patterns, he's well on track for a mid-level frontend role.",
  technical:
  ...
  sessionRating: 4,
  sessionComment:
    "Great session — Rishu was engaged and receptive to feedback. Would be happy to interview him again after he's done more system design prep.",
};
